...
const lastproductSchema = new mongoose.Schema({
  ...
  quantities: { type: Map, of: Number, default: {}, required: true }, 
});

const lastproductModel =
  mongoose.models.lastproduct ||
  mongoose.model("lastproduct", lastproductSchema);

export default lastproductModel;
